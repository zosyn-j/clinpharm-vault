...
|---|---:|---:|---:|---|
| Planned Phase 2b CSU study (sponsor slide deck) | 5 | 4 | NR | 4 active SEP-631 dose levels plus placebo; enrollment not disclosed in current source |

- Sponsor slide deck describes a planned global, randomized, double-blind, placebo-controlled Phase 2b CSU study with 4 SEP-631 dose levels plus placebo, 12-week treatment, adults 18 to 65 years with moderate to severe CSU who remain symptomatic on second-generation H1 antihistamine therapy (Septerna corporate slide deck, page 25).
## Study Inventory
