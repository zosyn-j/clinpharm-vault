...
|---|---|---|---:|---|
| Arm A1 (Part A): BLU-808 | EXPERIMENTAL | BLU-808 will be administered orally. | NR | Per-arm realized N not directly captured in current CT.gov inventory export |
| Arm A3 (Part A): BLU-808 | EXPERIMENTAL | BLU-808 will be administered orally. | NR | Per-arm realized N not directly captured in current CT.gov inventory export |
| Arm B (Part B): BLU-808/Placebo | EXPERIMENTAL | BLU-808 or matching placebo will be administered orally. | NR | Per-arm realized N not directly captured in current CT.gov inventory export |
