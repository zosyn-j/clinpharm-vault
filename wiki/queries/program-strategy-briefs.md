...
| [Fenebrutinib](../programs/fenebrutinib.md) | BTK | Phase 2 | 2 | 1 | Medium | Historical BTK CSU proof-of-concept program, not a visibly expanding current franchise in the local layer. |
| [Remibrutinib](../programs/remibrutinib.md) | BTK | Phase 3 | 16 | 4 | High | Broad BTK franchise strategy: establish CSU depth first, then layer on lifecycle, comparator, pediatric, CIndU, and real-world expansion. |
| [Rilzabrutinib](../programs/rilzabrutinib.md) | BTK | Phase 2 | 1 | 1 | Medium | More focused BTK challenger strategy in CSU, with a thinner visible development stack than remibrutinib. |
| [SEP-631](../programs/sep-631.md) | MRGPRX2 | NR | 0 | 0 | Low | Pipeline-visible MRGPRX2 program without a disclosed CT.gov study stack in the current local cache. |
...
### EP262
- Program page: [open](../programs/ep262.md)
...
### EVO756
- Program page: [open](../programs/evo756.md)
...
### Fenebrutinib
- Program page: [open](../programs/fenebrutinib.md)
...
### Remibrutinib
- Program page: [open](../programs/remibrutinib.md)
